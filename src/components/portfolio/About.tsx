              ...
              <div className="grid gap-5 md:grid-cols-2">
                {EXPERIENCE_ROLES.map((role, i) => (
                  <div key={i} className="min-w-0">
                    <div className="h-full rounded-2xl p-5 md:p-6 bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-sm hover:border-zinc-700/80 transition-colors min-w-0">
            ...
            >
              <div className="space-y-6">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    ...
                    <motion.div
                      key={index}
                      className="h-full p-4 md:p-5 rounded-2xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-sm hover:border-cyan-500/20 transition-colors"
                      variants={{ hidden: { opacity: 0, y: 8 }, visible: { opacity: 1, y: 0 } }}
                    >
                      <div className="font-medium text-cyan-400 mb-2 text-xs uppercase tracking-wider">{item.category}</div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-zinc-500 text-sm">Courses and credentials</p>
                </div>
                <div className="grid gap-4 md:grid-cols-2">
                  {CERTIFICATIONS.map((cert, index) => {
                    ...
                    return (
                      <motion.div
                        key={index}
                        className={`flex h-full items-start gap-4 p-5 rounded-xl border ${styles.box}`}
